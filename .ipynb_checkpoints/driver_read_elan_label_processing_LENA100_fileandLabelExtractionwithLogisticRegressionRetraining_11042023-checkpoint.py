...
goTraining = True
regression_trained = f".trained/regression_kyunghun_balanced_weight_option_penalty.joblib"
if goTraining:
    ...
    # clf = LogisticRegression(random_state=0,class_weight='balanced',C=C)
...
# Saving the figure
# save_path = os.path.join('analysis', 'analysis-10302023', f'normalized_confusion_matrix_regression_with_class_weight_C_{C}.png')
save_path = os.path.join('analysis', 'analysis-10302023', f'normalized_confusion_matrix_regression_with_class_weight.png')
