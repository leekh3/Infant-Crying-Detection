...
for inFile in inFiles:
    ...
    #     continue
    # for sub in [4893]:
    for sub in [2206,2866]: #3570,3021,1970,4259,2790,1939,3173,2501,3094,1879,3042,3649,2431,3649,3042
        if str(sub) in inFile:
            inFiles_new.append(inFile)
inFiles = inFiles_new
...
for i in range(len(inFiles)):
    ...
    outFile = outFolder + sdan + '_updated_by_kyunghun_04042023.wav'
    try:
...
df.to_csv(outFolder + '/output_summary_04042023.csv', index=False)