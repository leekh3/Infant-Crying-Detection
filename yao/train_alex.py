...
test_folders = ['P14',	'P20', 'P26.1',	'P27.1', 'P31']
test_folders.append('P0')
'''
...
for test_folder in test_folders:
	...
	for ind, test_episode in enumerate(test_episodes):
		...
		if ind <= -1:
			...
			predictions = list(np.argmax(model.predict(image_windows, batch_size=batch_size, verbose=1, steps=None), axis = 1))
